-- ========================================
-- نسخة محدثة - تتخطى الأجزاء الموجودة
-- Updated version - Skips existing parts
-- ========================================
...
-- حذف الـ policies القديمة أولاً (إذا كانت موجودة)
DROP POLICY IF EXISTS "Allow read access to consultation_types" ON consultation_types;
DROP POLICY IF EXISTS "Allow read access to active consultants" ON consultants;
DROP POLICY IF EXISTS "Allow admin full access to consultation_types" ON consultation_types;
DROP POLICY IF EXISTS "Allow admin full access to consultants" ON consultants;
DROP POLICY IF EXISTS "Allow admin full access to site_settings" ON site_settings;

-- إنشاء الـ policies من جديد
...
-- ========================================
-- ✅ تم! الآن يمكنك اختبار نظام الحجز
-- ✅ Done! Now you can test the booking system
-- ========================================
